...
// Add prop type interface
interface InteractionPanelProps {
    showHeader?: boolean;
    showNavigation?: boolean;
}

export default function InteractionPanel({ showHeader = true, showNavigation = true }: InteractionPanelProps) {
    const {
        currentStep,
        agentStatus,
        progressPercentage,
        ...
        switch (currentStep) {
                                ...
                                {onboardingData.jobPreference.job_titles.map(title => {
                                    ...
                                    return (
                                        <Badge
                                            key={title}
                                            variant="outline"
                                            className="h-9 px-4 py-2 rounded-full bg-white hover:bg-blue-50 text-foreground border-blue-200 hover:border-blue-300 gap-1"
                                        >
                                            ...
                                            <button
                                                ...
                                                className="ml-2 rounded-full hover:bg-blue-100 p-0.5"
                                            >
            ...
            case 'experience_level':
                return (
                    <div className="space-y-8">
                        <div>
                            <h3 className="text-xl font-semibold mb-4">Level of Roles</h3>
                            <div className="grid grid-cols-1 gap-3">
                                {experienceLevels.map(level => (
                                    <Badge
                                        key={level.value}
                                        variant="outline"
                                        className={`h-9 px-4 py-2 cursor-pointer rounded-full flex items-center justify-between
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            ...
                                            {suggestions && suggestions.recommended_experience_level === level.value && (
                                                <span className="text-xs bg-yellow-50 text-yellow-600 border border-yellow-200 rounded-full px-2 py-0.5">
                                                    Recommended
                                                </span>
                                            )}
                                        </div>
            ...
            case 'salary_expectations':
                return (
                    <div className="space-y-8">
                        <div>
                            <h3 className="text-xl font-semibold mb-4">Expected salary</h3>
                            <div className="grid grid-cols-1 gap-3">
            ...
            case 'job_search_status':
                return (
                    <div className="space-y-8">
                        <div>
                            <h3 className="text-xl font-semibold mb-4">Status of your job search</h3>
                            <div className="grid grid-cols-1 gap-3">
                ...
                return (
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="border-2 border-dashed border-blue-200 dark:border-blue-700 rounded-lg p-8 text-center bg-white">
                                <input
                                    type="file"
                                    id="resume-upload"
                                    accept=".pdf"
                                ...
                                >
                                    <div className="w-16 h-16 mb-4 flex items-center justify-center">
                                        {isUploading || agentStatus === 'processing_resume' ? (
                                            ...
                                            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M32 20V44" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" />
                                                <path d="M20 32H44" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" />
                                                <rect x="1" y="1" width="62" height="62" rx="31" stroke="#BFDBFE" strokeWidth="2" />
                                            </svg>
                                        )}
                                    </div>
                                    ...
                                    {!(isUploading || agentStatus === 'processing_resume') && (
                                        <Button
                                            variant="outline"
                                            className="bg-white border-blue-300 hover:bg-blue-50 hover:text-blue-600"
                                            onClick={(e) => {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden bg-white rounded-2xl">
            {/* Header with progress - only shown if showHeader is true */}
            {showHeader && (
            ...
            {/* Navigation buttons - only shown if showNavigation is true */}
            {showNavigation && (
