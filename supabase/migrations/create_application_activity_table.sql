...
-- Create indexes
CREATE INDEX idx_app_activity_user_id ON public.application_activity(user_id);
CREATE INDEX idx_app_activity_application_id ON public.application_activity(application_id);
CREATE INDEX idx_app_activity_created_at ON public.application_activity(created_at);
CREATE INDEX idx_app_activity_action_type ON public.application_activity(action_type);
